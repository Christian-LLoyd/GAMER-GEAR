...
public class Headphone3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_headphone3);
        ...
        imageView.setImageResource(HeadphoneImg[2]);
        title.setText(HeadphoneTitle[2]);
        description.setText(HeadphoneDesc[2]);
        price.setText(HeadphonePrice[2]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("13").child("title").setValue(mousetitle);
                databaseReference.child("13").child("price").setValue(mouseprice);
