...
public class Monitor1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(MonitorImg[0]);
        title.setText(MonitorTitle[0]);
        description.setText(MonitorDesc[0]);
        price.setText(MonitorPrice[0]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("16").child("title").setValue(mousetitle);
                databaseReference.child("16").child("price").setValue(mouseprice);
