...
public class Headphone5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_headphone5);
        ...
        imageView.setImageResource(HeadphoneImg[4]);
        title.setText(HeadphoneTitle[4]);
        description.setText(HeadphoneDesc[4]);
        price.setText(HeadphonePrice[4]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("15").child("title").setValue(mousetitle);
                databaseReference.child("15").child("price").setValue(mouseprice);
