...
public class Keyboard2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(KeyboardImg[1]);
        title.setText(KeyboardTitle[1]);
        description.setText(KeyboardDesc[1]);
        price.setText(KeyboardPrice[1]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("7").child("title").setValue(mousetitle);
                databaseReference.child("7").child("price").setValue(mouseprice);
