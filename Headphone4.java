...
public class Headphone4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_headphone4);
        ...
        imageView.setImageResource(HeadphoneImg[3]);
        title.setText(HeadphoneTitle[3]);
        description.setText(HeadphoneDesc[3]);
        price.setText(HeadphonePrice[3]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("14").child("title").setValue(mousetitle);
                databaseReference.child("14").child("price").setValue(mouseprice);
