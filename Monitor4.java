...
public class Monitor4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(MonitorImg[3]);
        title.setText(MonitorTitle[3]);
        description.setText(MonitorDesc[3]);
        price.setText(MonitorPrice[3]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("19").child("title").setValue(mousetitle);
                databaseReference.child("19").child("price").setValue(mouseprice);
