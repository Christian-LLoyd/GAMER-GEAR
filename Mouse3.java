...
public class Mouse3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mouse3);
        ...
        imageView.setImageResource(MouseImg[2]);
        title.setText(MouseTitle[2]);
        description.setText(MouseDesc[2]);
        price.setText(MousePrice[2]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("3").child("title").setValue(mousetitle);
                databaseReference.child("3").child("price").setValue(mouseprice);
