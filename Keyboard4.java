...
public class Keyboard4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_keyboard4);
        ...
        imageView.setImageResource(KeyboardImg[3]);
        title.setText(KeyboardTitle[3]);
        description.setText(KeyboardDesc[3]);
        price.setText(KeyboardPrice[3]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("9").child("title").setValue(mousetitle);
                databaseReference.child("9").child("price").setValue(mouseprice);
