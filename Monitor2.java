...
public class Monitor2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(MonitorImg[1]);
        title.setText(MonitorTitle[1]);
        description.setText(MonitorDesc[1]);
        price.setText(MonitorPrice[1]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("17").child("title").setValue(mousetitle);
                databaseReference.child("17").child("price").setValue(mouseprice);
