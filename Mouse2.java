...
public class Mouse2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(MouseImg[1]);
        title.setText(MouseTitle[1]);
        description.setText(MouseDesc[1]);
        price.setText(MousePrice[1]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("2").child("title").setValue(mousetitle);
                databaseReference.child("2").child("price").setValue(mouseprice);
