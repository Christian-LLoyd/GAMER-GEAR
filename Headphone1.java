...
public class Headphone1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_headphone1);
        ...
        imageView.setImageResource(HeadphoneImg[0]);
        title.setText(HeadphoneTitle[0]);
        description.setText(HeadphoneDesc[0]);
        price.setText(HeadphonePrice[0]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("11").child("title").setValue(mousetitle);
                databaseReference.child("11").child("price").setValue(mouseprice);
