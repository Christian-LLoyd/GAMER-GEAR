...
public class Mouse1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(MouseImg[0]);
        title.setText(MouseTitle[0]);
        description.setText(MouseDesc[0]);
        price.setText(MousePrice[0]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("1").child("title").setValue(mousetitle);
                databaseReference.child("1").child("price").setValue(mouseprice);
