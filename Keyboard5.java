...
public class Keyboard5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_keyboard5);
        ...
        imageView.setImageResource(KeyboardImg[4]);
        title.setText(KeyboardTitle[4]);
        description.setText(KeyboardDesc[4]);
        price.setText(KeyboardPrice[4]);
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("10").child("title").setValue(mousetitle);
                databaseReference.child("10").child("price").setValue(mouseprice);
